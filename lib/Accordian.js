...
var Accordion = function (_a) {
    var _b = _a.id, id = _b === void 0 ? Math.floor(Math.random() * Date.now()) : _b, title = _a.title, content = _a.content, _c = _a.wrap, wrap = _c === void 0 ? false : _c, _d = _a.defaultOpen, defaultOpen = _d === void 0 ? false : _d, _e = _a.expandIcon, expandIcon = _e === void 0 ? null : _e, _f = _a.collapseIcon, collapseIcon = _f === void 0 ? null : _f, _g = _a.animation, animation = _g === void 0 ? true : _g, _h = _a.animationDuration, animationDuration = _h === void 0 ? 0.25 : _h, _j = _a.children, children = _j === void 0 ? react_1.default.createElement(react_1.default.Fragment, null) : _j, _k = _a.reverseIconPosition, reverseIconPosition = _k === void 0 ? false : _k, _l = _a.iconSize, iconSize = _l === void 0 ? 16 : _l, _m = _a.onClick, onClick = _m === void 0 ? function () { } : _m, _o = _a.onExpand, onExpand = _o === void 0 ? function () { } : _o, _p = _a.onCollapse, onCollapse = _p === void 0 ? function () { } : _p, _q = _a.activeTitleColor, activeTitleColor = _q === void 0 ? '#22242E' : _q, _r = _a.contentCharLimit, contentCharLimit = _r === void 0 ? null : _r;
    var _s = react_1.useState(defaultOpen), isOpen = _s[0], setIsOpen = _s[1];
